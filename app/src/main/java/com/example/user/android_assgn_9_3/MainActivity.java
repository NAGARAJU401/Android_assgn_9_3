...
//creating array list object
        mArrayList.add(new Student("sudha", "9863782518"));
        mArrayList.add(new Student("nagaraju", "8734876987"));
        mArrayList.add(new Student("vamshi", "9735289254"));
        mArrayList.add(new Student("srujan", "9546217854"));
        mArrayList.add(new Student("prasana", "9995553330"));
        mArrayList.add(new Student("sandya", "9876543233"));
        mArrayList.add(new Student("lucky", "9764738364"));
